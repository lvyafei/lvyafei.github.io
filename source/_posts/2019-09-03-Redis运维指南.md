...
```
[root@roznjytjd12 ~]# redis-cli -h 10.29.185.50 -p 6379 -a 'zx0923ldz'
Warning: Using a password with '-a' option on the command line interface may not be safe.
10.29.185.50:6379> get intelli:cusbasic:2100056422
(error) MOVED 15848 10.29.185.50:7000
10.29.185.50:6379>
```

使用集群模式，未设置集群连接密码，查询失败：
```
[root@roznjytjd12 ~]# redis-cli -h 10.29.185.50 -p 6379 -c
10.29.185.50:6379> get intelli:cusbasic:2100056422
(error) NOAUTH Authentication required.
10.29.185.50:6379> auth zx0923ldz
OK
10.29.185.50:6379> get intelli:cusbasic:2100056422
-> Redirected to slot [15848] located at 10.29.185.50:7000
(error) NOAUTH Authentication required.
10.29.185.50:7000>
```
...
```
[root@roznjytjd12 ~]# redis-cli -h 10.29.185.50 -p 6379 -a 'zx0923ldz' -c
Warning: Using a password with '-a' option on the command line interface may not be safe.
10.29.185.50:6379> get intelli:cusbasic:2100056422
-> Redirected to slot [15848] located at 10.29.185.50:7000
"{\"@class\":\"zts.intelli.core.po.CustomerBasicInfo\",\"id\":28,\"customerNo\":\"2100056422\",\"orgid\":\"0021\",\"serverid\":\"4\",\"createdate\":[\"java.util.Date\",1567669166000]}"
10.29.185.50:7000>
```
